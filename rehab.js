function findNearestMarker(coords) {
    ...
    if(nearest_text==1){
      logEvent("Contact no: 787353633, John");
      logEvent("Open now");
      logEvent("Relief Camp: GovernmentHSS Thriuvalla");
      logEvent("---------------------------------------------------------------------------------");
    }
    else if(nearest_text==2){
      logEvent("Contact no: 78735633, Remya");
      logEvent("Open now");
      logEvent("Relief Camp: NSS Camp");
      logEvent("---------------------------------------------------------------------------------");
    }

    else if(nearest_text==3){
      logEvent("Contact no: 187000633, Seetha");
      logEvent("Closed");
      logEvent("Relief Camp: Government Women's College");
      logEvent("---------------------------------------------------------------------------------");
    }

    else if(nearest_text==4){
      logEvent("Contact no: 658735633, Ram");
      logEvent("Open");
      logEvent("Relief Camp: MD Seminary School");
      logEvent("---------------------------------------------------------------------------------");
    }

    else if(nearest_text==5){
      logEvent("Contact no: 468735633, Alice");
      logEvent("Open now");
      logEvent("Relief Camp: St Mary's Convent");
      logEvent("---------------------------------------------------------------------------------");
    }
  ...
  var platform = new H.service.Platform({
    apikey: 'B6bgO06hBeJAP1CYIdr2',
    app_code: 'MZC6JBLjiH-YBd9byBiSaA'
  });
  ...
  // Set up five markers.
  var coords = [{ lat:9.3834, lng:76.5740},
    { lat: 9.7057, lng: 76.6977 },
    { lat: 9.4498, lng: 76.6701 },
    { lat: 9.5595, lng: 76.7874 },
    { lat: 9.6741, lng: 76.3401 }];
